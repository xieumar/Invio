...
export const seedData: Invoice[] = [
  ...
  },
  {
    ...
    items: [
      { id: "1", name: "Project Documentation", quantity: 1, price: 10.33, total: 10.33 },
      { id: "2", name: "Project Estimation", quantity: 1, price: 13992.0, total: 13992.0 },
    ],
    total: 14002.33,
  },
  {
  ...
  },
  {
    ...
    status: "pending",
    senderAddress: { street: "19 Union Terrace", city: "London", postCode: "E1 3EZ", country: "United Kingdom" },
    clientAddress: { street: "3 Gotham City", city: "Gotham", postCode: "DC1 5GB", country: "United States of America" },
    items: [{ id: "1", name: "Web Design", quantity: 1, price: 6155.91, total: 6155.91 }],
    total: 6155.91,
  },
  {
    id: "FV2353",
